...
$query = $relatorio->filterActiveReports();

$pdf_content = "<h2 style='text-align: center; font-style: italic; margin: 50px;'>Relatório de Ativos no sistema </h2>"
...
$dompdf->render();
$dompdf->stream("people_report.pdf", array("Attachment" => false));